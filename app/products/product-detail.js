System.register(['angular2/core', 'angular2/router', '../shared/star.component', './product.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, star_component_1, product_service_1;
    ...
    return {
        ...
        execute: function() {
            ProductDetailComponent = (function () {
                function ProductDetailComponent(router, _productService) {
                    this.router = router;
